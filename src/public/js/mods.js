...
const mql = w.matchMedia("(min-width: 992px)");
const mql2= w.matchMedia("min-width: 768px");
...
const c3 = `
<div>
                    <h4 class="text-center"><i class="fas fa-file-invoice-dollar fs-2 px-3"></i>Módulo 3: Sueldos</h4>
                </div>
                <hr>
                <ul class="list-group list-group-flush w-75">
...
const c4 = `
<div>
                    <h4 class="text-center"><i class="fas fa-calculator fs-2 px-3"></i>Módulo 4: Contabilidad</h4>
                </div>
                <hr>
                <ul class="list-group list-group-flush w-75">
                    <h4>Próximamente</h4>
                  </ul>`;
const mobile = `<div class="accordion" id="accordionExample">
<div class="accordion-item">
  <h2 class="accordion-header" id="headingOne">
    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne" aria-expanded="false" aria-controls="collapseOne">
        <h5><i class="fas fa-book fs-2 px-3"></i>Módulo 1: Asistente Contable Inicial</h5>
    </button>
  </h2>
...
<div class="accordion-item">
  <h2 class="accordion-header" id="headingTwo">
    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
        <h5><i class="fas fa-graduation-cap fs-2 px-3"></i>Módulo 2: Asistente Contable Avanzado</h5>
    </button>
  </h2>
...
<div class="accordion-item">
  <h2 class="accordion-header" id="headingThree">
    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
        <h5><i class="fas fa-file-invoice-dollar fs-2 px-3"></i>Módulo 3: Sueldos</h5>
    </button>
  </h2>
...
<div class="accordion-item">
    <h2 class="accordion-header" id="headingFour">
      <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseFour" aria-expanded="false" aria-controls="collapseFour">
          <h5><i class="fas fa-calculator fs-2 px-3"></i>Módulo 4: Contabilidad</h5>
      </button>
    </h2>
...
const resp = ()=>{
    if(mql.matches){
        ...
        let ch = d.createElement("div");
        ch.classList.add("card-header");
        ch.innerHTML = `<ul class="nav nav-pills nav-justified">
        <li class="nav-item">
          <a class="nav-link active"href="#" id="m1">Inicial</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="#" id="m2">Avanzado</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="#" id="m3">Sueldos</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="#" id="m4">Contabilidad</a>
        </li>
      </ul>`
      
        let cb = d.createElement("div");
        ...
        const m1 = d.getElementById("m1");
        const m2 = d.getElementById("m2");
        const m3 = d.getElementById("m3");
        const m4 = d.getElementById("m4");

        let modulos = [m1,m2,m3,m4];

        modulos.forEach(m => {
            m.addEventListener("click",()=>{
                switch(m.id){
                    case "m1": cb.innerHTML = c1;
                    if(m1.classList.contains("active") == false){
                    ...
                    break;
                    case "m2": cb.innerHTML = c2; 
                    if(m2.classList.contains("active") == false){
                    ...
                    break;
                    case "m3": cb.innerHTML = c3;
                    if(m3.classList.contains("active") == false){
                    ...
                    break;
                    case "m4": cb.innerHTML = c4;
                    if(m4.classList.contains("active") == false){
...
d.addEventListener("DOMContentLoaded",resp);
w.addEventListener("resize",resp);